...
std::shared_ptr<Learn::View::ViewerManager> viewer = nullptr;
...
//    glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
  ...
  // init Viewer
  viewer = std::make_shared<Learn::View::ViewerManager>();
  bool initSuccess = viewer->create(window, SCR_WIDTH, SCR_HEIGHT, (int) texture);
  if (!initSuccess) {
    LOG_ERROR("Failed to create Viewer");
  } else {

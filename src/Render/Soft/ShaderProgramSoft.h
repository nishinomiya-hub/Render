...
namespace Learn
{
    ...
    public:
        ...
        bool SetShaders(std::shared_ptr<ShaderSoft> vs, std::shared_ptr<ShaderSoft> fs)
        {
            ...
            definesBuffer_ = AlignedMemory::makeBuffer<uint8_t>(defineDesc.size());
            ...
            // uniforms
            uniformBuffer_ = AlignedMemory::makeBuffer<uint8_t>(vertexShader_->getShaderUniformsSize());

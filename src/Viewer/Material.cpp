...
#define CASE_ENUM_STR(type) \
    case type:              \
        ...
        const char *Material::samplerDefine(MaterialTexType type)
        {
            switch (type)
            {
            case MaterialTexType_ALBEDO:
                return "ALBEDO_MAP";
            case MaterialTexType_NORMAL:
                return "NORMAL_MAP";
            case MaterialTexType_EMISSIVE:
                return "EMISSIVE_MAP";
            case MaterialTexType_AMBIENT_OCCLUSION:
                return "AO_MAP";
            case MaterialTexType_METAL_ROUGHNESS:
                return "METALROUGHNESS_MAP";
            case MaterialTexType_CUBE:
                return "CUBE_MAP";
            case MaterialTexType_EQUIRECTANGULAR:
        ...
        const char *Material::samplerName(MaterialTexType type)
        {
            switch (type)
            {
            case MaterialTexType_ALBEDO:
            ...
            case MaterialTexType_QUAD_FILTER:
                return "u_screenTexture";
            case MaterialTexType_SHADOWMAP:
                return "u_shadowMap";
            default:
                break;
            }

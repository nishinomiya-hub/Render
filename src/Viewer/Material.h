    ...
    namespace View
    {
        ...
        { 
            public:
                ...
                static const char *materialTexTypeStr(MaterialTexType type);
                static const char *samplerDefine(MaterialTexType type);
                static const char *samplerName(MaterialTexType type);

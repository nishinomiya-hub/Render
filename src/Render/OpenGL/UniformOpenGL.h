...
#include "Render/Base/Uniform.h"

#define BIND_TEX_OPENGL(n)                        \
    case n:                                       \
        GL_CHECK(glActiveTexture(GL_TEXTURE##n)); \
        break;
...
namespace Learn
{
    ...
    public:
        ...
        void bindProgram(ShaderProgram &program, int location) override
        {
            ...
            default:
            {
                LOG_ERROR("UniformSampler::bindProgram error: texture unit not support");
                break;
            }
            }
        ...
        void setTexture(const std::shared_ptr<Texture> &tex) override
        {
            ...
            case TextureType_CUBE:
                ...
                break;
            default:
                LOG_ERROR("UniformSampler::setTexture error: texture type not support");
                break;
            }
            texId_ = tex->getId();
        }
